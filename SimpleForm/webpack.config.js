...
module.exports = {    
    devServer: {
         ...
         */
         ...
         // ref = https://www.reddit.com/r/reactjs/comments/4xury9/react_webpack_and_api_calls/
         // ref = https://stackoverflow.com/questions/54333282/how-can-i-activate-cors-in-create-react-app
         // ref = https://www.reddit.com/r/reactjs/comments/7kfqwi/using_reactjs_axios_how_do_you_bypass_cors_when/
         /*
         proxy: {
            '/api': {
               target: {
    ...
    // https://stackoverflow.com/questions/47912805/how-to-put-react-in-production-mode
    entry: "./index.web.js",
    output: {
    ...
    // per https://webpack.js.org/plugins/uglifyjs-webpack-plugin/#requirements
    /*
    optimization: {
        minimize: true,
        minimizer: [
            new UglifyJsPlugin({
                test: /\.js(\?.*)?$/i, // https://github.com/webpack/webpack/issues/6879
                output: {
                    comments: false
                },
            }),
